...
async def get_thumb(videoid):
    ...
    try:
        ...
        bg = Image.open(f"AarumiMusic/assets/aarumi.png")
        ...
        font = ImageFont.truetype("AarumiMusic/assets/font2.ttf", 45)
        font2 = ImageFont.truetype("AarumiMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("AarumiMusic/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("AarumiMusic/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=30)
        j = 0
        draw.text((5, 5), f"AarumiXshiv", fill="white", font=name_font)
        for line in para:
            if j == 1:
                j += 1
                draw.text(
